                    ...
                    <td>
                      <table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#32a6c4" style="padding: 15px;background-color: #9f2109;">
                        <tr>
                          <td>
                            <div>
                              <center style="color: #fff; font-size: 18px;text-decoration: underline;"> IP WARNING MAIL </center>
                            </div>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table cellspacing="0" border="0" cellpadding="0" width="100%" style="padding: 15px 15px 0px 15px;background-color: #fff;">
                        ...
                        <tr>
                          <td colspan="2" style="color: #000000;">
                            Recieve two account with same IP Address 
                            <br>
                            <br>Account Detail is given below
                           
                          </td>
                        </tr>
                      </table>

                      <table class="table" cellspacing="0" border="0" cellpadding="0" width="100%" style="padding: 15px; color: #000000;">
                        <thead>
                        <tr>
                          <th>User Type</th>
                          <th>Full Name</th>
