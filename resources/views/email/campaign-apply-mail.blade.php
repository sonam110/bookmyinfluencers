...
<body>
<p>Hi {{ @$content['proposal']->brandInfo->fullname }},</p>

<p>You&#39;ve received a new proposal on your&nbsp;campaign {{ @$content['proposal']->campInfo->camp_title }}.</p>

<p>You can login to your account to check for any influencer proposals or to invite influencers to participate in the campaign.</p>
                    ...
                    <td>
                      <table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#32a6c4" style="padding: 15px;background-color: #9f2109;">
                        <tr>
                          <td>
                            <div>
                              <center style="color: #fff; font-size: 18px;text-decoration: underline;">INFLUNCER APPLICATION </center>
                            </div>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table cellspacing="0" border="0" cellpadding="0" width="100%" style="padding: 15px 15px 0px 15px;background-color: white;">
                        ...
                        <tr>
                          <td colspan="2" style="color: #000000;">
                            Dear {{ $content['proposal']->brandInfo->fullname}},<br>
                            We have received application from influencer {{ $content['proposal']->infInfo->fullname }} .
                            <br>
                            <br>
