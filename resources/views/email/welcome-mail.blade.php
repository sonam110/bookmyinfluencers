...
<p>Thanks for joining <strong>BookMyInfluencers</strong>. Your account has been created. Please login to Bookmyinfluencers with your account details.</p>

<p>To get started, simply <a href="https://bookmyinfluencers.com/">log in</a> to your account and start exploring influencers and run campaigns to reach your target audience effectively.</p>

<p>We highly recommend whitelisting offer notification email so that you never miss out on any paid offer. Don&#39;t hesitate to reach out to our support team if you have any questions.</p>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        <img align="center" border="0" src="{{asset('handshake.png')}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 26%;max-width: 150.8px;" width="150.8"/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                            ...
                                                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">
                                                                        We welcome you to BookMyInfluencers. Over here, quality is above everything else.

                                                                        Feel free to search or browse campaigns and apply filters to narrow down results as per your requirements.
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;">
                                                                    <span style="font-size: 18px; line-height: 28.8px;">BookMyInfluencers Team</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div style="color: #fafafa; line-height: 180%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 180%;">
                                                                    <span style="font-size: 16px; line-height: 28.8px;">Copyrights &copy; BookMyInfluencers All Rights Reserved</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
